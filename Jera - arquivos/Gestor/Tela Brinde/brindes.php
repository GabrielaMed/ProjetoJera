                                ...
                                <div class="modal_aviso_inativar" id="ativar<?php echo $strid; ?>">
                                    <div class="modal_content_inativar">
                                        <form action="../../bd/ativarBrinde.php" method="post">
                                            ...
                                            <div class="head_modal_aviso">
                                                <h2 class="tit_modal">Tem certeza que deseja ativar o brinde <?php echo $nome_brinde;?> ?</h2>
                                            </div>
                                            <div class="footer_modal_estoque">
                                                <div id="cancelar_btn">
                                                    <a class="btn" id="btn_cancelarColab" href="">Cancelar</a>
...
// aq
                ...
                <div class="modal_confirmar_inativar" id="Conf_inativar">
                    ...
                    <div class="modal_content_inativar">
                        ...
                        <div class="head_modal_aviso">
                            <h2 class="tit_modal">Brinde inativado com sucesso!</h2>
                        </div>
                        ...
                        <form class="body_modal_aviso">
                                ...
                                <div class="footer_modal_estoque">
                                    <div id="salvar_btn">
                                        <button  class="btn" id="btn_salvarColab">OK</button>                       
                                    </div>
                                </div>                                
